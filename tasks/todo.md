...
- [ ] H1・7見出し・順序・元記事一覧/参考ソース一覧のURLはコードが組み立てる

## フェーズ3: 合格基準の見直し
- [ ] 作り上げられたURLは本文から取り除き警告として記録（決定: B）
- [ ] 本文の日本語判定、空セクション却下、700文字以上、定型文禁止、Reviewer、情報量非減少は維持

## フェーズ4: 評価してから本番へ
- [ ] 評価5件中3件以上合格を確認してから本番投入し、定期実行で確認
